...
namespace Photon.LoadBalancing.LoadShedding
{
    ...
    internal sealed class FeedbackControlSystem : IFeedbackControlSystem, IDisposable
    {
        ...
        public FeedbackControlSystem(int maxCcu)
        {
            ...
            this.fileWatcher = new FileSystemWatcher(AppDomain.CurrentDomain.BaseDirectory, GameServerSettings.Default.WorkloadConfigFile);
        ...
        private void Initialize()
        {
            ...
            string filename = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, GameServerSettings.Default.WorkloadConfigFile);
