...
namespace Lite.Tests.Disconnected
{
    ...
    public class DummyPeer : IPhotonPeer
    {
        ...
        SendResults IPhotonPeer._InternalBroadcastSend(byte[] data, MessageReliablity reliability, byte channelId)
        {
        ...
        ///   Always Ok.
        /// </returns>
        public SendResults Send(byte[] data, MessageReliablity reliability, byte channelId)
        {
