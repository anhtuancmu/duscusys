...
namespace Lite
{
    ...
    public class LiteGame : Room
    {
        ...
        /// </summary>
        private readonly Dictionary<int, EventCache> cachedEvents = new Dictionary<int, EventCache>();

        private readonly RoomEventCache roomEventCache = new RoomEventCache();
        ...
        protected void PublishEventCache(LitePeer litePeer)
        {
            ...
            foreach (KeyValuePair<int, EventCache> entry in this.cachedEvents)
            {
                int actor = entry.Key;
            ...
            foreach (CustomEvent customEvent in this.roomEventCache)
            {
