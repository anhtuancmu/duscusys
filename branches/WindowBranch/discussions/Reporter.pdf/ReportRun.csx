#r "C:\projects\TDS\discussions\References\itextsharp.dll"
#r "C:\projects\TDS\discussions\packages\Microsoft.CompilerServices.AsyncTargetingPack.1.0.0\lib\net40\Microsoft.CompilerServices.AsyncTargetingPack.Net4.dll"
#r "C:\projects\TDS\discussions\References\Microsoft.Data.ConnectionUI.Dialog.dll"
#r "C:\projects\TDS\discussions\References\Microsoft.Data.ConnectionUI.SqlCeDataProvider.dll"
#r "Microsoft.Surface"
#r "Microsoft.Surface.Presentation"
#r "C:\projects\TDS\discussions\References\MigraDoc.DocumentObjectModel-WPF.dll"
#r "C:\projects\TDS\discussions\References\MigraDoc.Rendering-WPF.dll"
#r "C:\projects\TDS\discussions\References\PDFjet.dll"
#r "C:\projects\TDS\discussions\References\PdfSharp-WPF.dll"
#r "C:\projects\TDS\discussions\ExitGames-Photon-Server-SDK_v3-0-24-3243-RC9\lib\Photon3DotNet.dll"
#r "System"
#r "System.Data"
...
#r "System.Windows.Input.Manipulations"
#r "C:\projects\TDS\discussions\References\System.Windows.Interactivity.dll"
#r "System.Xml"
#r "System.Core"
#r "System.Xml.Linq"
#r "System.Data.DataSetExtensions"
#r "System.Xaml"
#r "C:\projects\TDS\discussions\webkit\WebKitBrowser.dll"
#r "WindowsBase"
#r "PresentationCore"
#r "PresentationFramework"
#r "WindowsFormsIntegration"
#r "C:\projects\TDS\discussions\References\WPFToolkit.Extended.dll"
#r "C:\projects\TDS\discussions\CloudStorage\bin\Debug\CloudStorage.exe"
#r "C:\projects\TDS\discussions\DbModel\bin\Debug\DbModel.dll"
#r "C:\projects\TDS\discussions\DiscussionsClientRT\bin\Debug\DiscussionsClientRT.exe"
#r "C:\projects\TDS\discussions\ExitGames-Photon-Server-SDK_v3-0-24-3243-RC9\deploy\DiscussionsRT\bin\DiscussionsRT.dll"
#r "C:\projects\TDS\discussions\LoginEngine\bin\Debug\LoginEngine.dll"
#r "C:\projects\TDS\discussions\Reporter\bin\Debug\Reporter.exe"
#r "C:\projects\TDS\discussions\WPFColorPicker\DropDownCustomColorPicker\bin\Debug\CustomColorPicker.dll"
#r "C:\projects\TDS\discussions\obj\Debug\Interop.Acrobat.dll"
#r "C:\projects\TDS\discussions\obj\Debug\AxInterop.AcroPDFLib.dll"
#r "Discussions.exe"
...
public class PdfAssembler5
{
	...
	public PdfAssembler5(Discussion discussion, Topic topic, Person person,
	...
	public void Run()
	{
		//  try
		{
			...
			DiscussionBackground().GetAwaiter().OnCompleted(()=> 
			{
	...
	private void DiscussionBgMediaTable()
	{
		...
		var header = PdfTools3.MakeSectionHeader("Media of discussion background", _mainFont);

		MediaTable(page, header, _discussion.Attachment, 50);
	}

	void MediaTable(Page page, TextLine sectionHeader, IEnumerable<Attachment> media, float top, int tableColor = -1)
	{
		var column = new TextColumn(_mainFont);
		column.SetPosition(PdfTools3.LEFT_MARGIN, PdfTools3.TOP_MARGIN + 50);
		column.SetSize(PdfTools3.ContentWidth(page.GetWidth()), page.GetHeight());

		var para = new Paragraph();
		column.AddParagraph(para);

		para.Add(sectionHeader);
		...
		foreach (var att in media)
		{
			...
			var fis1 = new FileStream(pathName, FileMode.Open, FileAccess.Read);
			var image1 = new Image(_document, fis1, ImageType.PNG);

			var line = new TextLine(_mainFont,
									string.Format("{0}. {1}", number++, att.Link) + " " + pathName);

			para.Add(line);
		
            Console.WriteLine("line.GetDestinationY()={0}", line.GetDestinationY());
			image1.SetPosition(0, line.GetDestinationY());
			image1.DrawOn(page);
	...
	private void RenderMultiPageTable(Table t, Page page)
	{
		while (true)
		{
			t.DrawOn(page);
			if (!t.HasMoreData())
			{
				...
				t.ResetRenderedPagesCount();
				break;
			}
			page = new Page(_document, Letter.PORTRAIT);
		}
	}
...
public class PdfReportDriver
{
	public void Run(Session session, Topic topic, Discussion discussion, Person person)
	{
		...
		var pdfAsm = new PdfAssembler5(discussion, topic, person, session,
...
(new PdfReportDriver()).Run(SessionInfo.Get().person.Session, pdfTopic, SessionInfo.Get().discussion, SessionInfo.Get().person);